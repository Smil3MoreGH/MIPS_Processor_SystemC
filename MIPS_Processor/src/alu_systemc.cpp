...
void alu_systemc::Behavioral()
{
    ...
    {
        case 0: alu_result.write(a.read().to_uint() + b.read().to_uint());         // add
            break;
        case 1: alu_result.write(a.read().to_uint() - b.read().to_uint());         // sub
            break;
        case 2: alu_result.write(a.read() & b.read());          					// and
            break;
        case 3: alu_result.write(a.read() | b.read());         						// or
            break;
        case 4:
            if (a.read().to_uint() < b.read().to_uint())
            	...
            	alu_result = 0x0000;
            break;
        default: alu_result.write(a.read().to_uint() + b.read().to_uint());            // add
    }
